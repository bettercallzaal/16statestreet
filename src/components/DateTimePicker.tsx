  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="bg-slate-700 border border-slate-600 rounded text-white text-sm font-medium px-2 py-1.5 focus:border-rose-500 focus:outline-none cursor-pointer whitespace-nowrap hover:bg-slate-600 transition-colors"
      >
