  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <input
        ...
        className="w-full pl-10 pr-9 py-2 bg-slate-800 border border-slate-600 text-white placeholder-slate-400 rounded-lg text-sm focus:outline-none focus:border-rose-500 transition-colors"
      />
      {localValue && (
        <button
          onClick={handleClear}
