            ...
            {step === 'input' && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-4 py-2.5 bg-rose-500 hover:bg-rose-600 disabled:opacity-50 text-white rounded-lg text-sm font-medium transition-colors cursor-pointer flex items-center justify-center gap-2"
                >
                  {fetchLoading ? (
                    <>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg text-white text-sm px-3 py-2 focus:border-rose-500 focus:outline-none"
                  >
                    {EVENT_TABS.map((tab) => (
                ...
                <div className="flex items-center gap-6">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-slate-600 bg-slate-900 text-rose-500 focus:ring-rose-500 focus:ring-offset-0 cursor-pointer"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg text-white text-sm px-3 py-2 focus:border-rose-500 focus:outline-none placeholder:text-slate-500 resize-none"
                  />
                </div>
