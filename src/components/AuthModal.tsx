          ...
          <div className="px-4 py-5">
            {step === 'email' && (
              <form onSubmit={handleEmailSubmit}>
                ...
                <div className="flex items-center gap-2 bg-slate-900 border border-slate-600 rounded-lg px-3 py-2.5 focus-within:border-rose-500 transition-colors">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-4 px-4 py-2.5 bg-rose-500 hover:bg-rose-600 disabled:opacity-50 text-white rounded-lg text-sm font-medium transition-colors cursor-pointer"
                >
                ...
                <div className="flex justify-center gap-2" onPaste={handlePaste}>
                  {code.map((digit, i) => (
                    <input
                      ...
                      className="w-10 h-12 bg-slate-900 border border-slate-600 rounded-lg text-white text-center text-lg font-bold outline-none focus:border-rose-500 transition-colors"
                    />
                  ))}
                </div>
                {error && <p className="text-red-400 text-xs mt-3 text-center">{error}</p>}
                {loading && <p className="text-rose-400 text-xs mt-3 text-center">Verifying...</p>}
                <button
    ...
    <div className="flex items-center gap-3 py-2">
      ...
      {result.request_status === 'pending_outgoing' ? (
        ...
        <button
          ...
          disabled={sending === result.user_id}
          className="flex items-center gap-1 text-xs font-medium bg-rose-500 hover:bg-rose-600 disabled:opacity-50 text-white px-2.5 py-1.5 rounded-lg transition-colors cursor-pointer"
        >
  ...
  return (
    <>
      ...
      >
        ...
        {badgeCount > 0 && (
          <span className="absolute -top-1 -right-1 min-w-[16px] h-[16px] flex items-center justify-center text-[9px] font-bold rounded-full bg-rose-500 text-white px-0.5">
            {badgeCount}
          </span>
        )}
      </button>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-xl shadow-2xl w-full max-w-sm" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="max-h-[80vh] overflow-y-auto px-4 py-5 space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <input
                      ...
                      className="w-full bg-slate-900 border border-slate-600 rounded-lg text-white text-sm px-3 py-2 focus:border-rose-500 focus:outline-none placeholder:text-slate-500"
                    />
                  </div>

                  <div>
                    <div className="flex items-center bg-slate-900 border border-slate-600 rounded-lg focus-within:border-rose-500">
                ...
                <div className="border-t border-slate-700 pt-4 space-y-3">
                  ...
                  {/* Search for friends */}
                  <div className="flex items-center gap-2 bg-slate-900 border border-slate-600 rounded-lg px-3 py-2 focus-within:border-rose-500 transition-colors">
