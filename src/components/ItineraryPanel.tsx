          ...
          <div className="flex items-center gap-1">
            {itineraryEvents.length > 0 && (
              <>
                <Link
                  href="/itinerary"
                  className="p-1.5 text-slate-400 hover:text-rose-400 active:text-rose-400 transition-colors"
                ...
                <button
                  ...
                  className="p-1.5 text-slate-400 hover:text-rose-400 active:text-rose-400 transition-colors cursor-pointer"
                ...
                <button
                  ...
                  disabled={exporting}
                  className="p-1.5 text-slate-400 hover:text-rose-400 active:text-rose-400 transition-colors cursor-pointer disabled:opacity-50"
            ...
            <>
              ...
              <div ref={captureRef} className="bg-slate-900">
                ...
                <div className="pt-3 pb-1 px-1 flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-white">Heart of Ellsworth</span>
                        ...
                        return (
                          ...
                          >
                            ...
                            {dropIndicator.showAbove && (
                              <div className="absolute -top-1.5 left-0 right-0 h-0.5 bg-rose-500 rounded-full z-10" />
                            )}
                            ...
                            {dropIndicator.showBelow && (
                              <div className="absolute -bottom-1.5 left-0 right-0 h-0.5 bg-rose-500 rounded-full z-10" />
                            )}
                          </div>
                        );
                      })}
                ...
                <div className="pt-3 pb-2 text-center">
                  <span className="text-[10px] text-slate-600">Heart of Ellsworth — community events</span>
                </div>
              </div>
