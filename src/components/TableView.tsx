...
export function TableView({
  ...
  const downloadCSV = useCallback(() => {
    ...
    a.href = url;
    a.download = 'ellsworth-events.csv';
    ...
    <>
      ...
      >
        ...
        <td
          ...
          className="px-3 py-1.5 text-xs font-semibold text-rose-400/80 uppercase tracking-wider border-b border-slate-700/70"
        >
          {group.label}
        </td>
      </tr>
              ...
              {(() => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    {fc > 0 && (
                      <span className="absolute -top-1 -right-1.5 min-w-[14px] h-[14px] flex items-center justify-center rounded-full bg-rose-500 text-white text-[8px] font-bold px-0.5 pointer-events-none">
                        {fc}
                      </span>
                    )}
                  </button>
